    ...
    <section ref={sectionRef} id="profile" className="section profile-section">
      <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
        ...
        <div className="profile-content">
          ...
          <h2 className="text-xl text-blue-400 font-medium mb-4">Analyst - Quality and Projects</h2>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              ...
              <span className="relative flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 transition-transform duration-300 group-hover:translate-y-1" viewBox="0 0 20 20" fill="currentColor">
